/*
  Run this ONCE on the Downtime SQL Server instance (192.168.100.222, database
  "Downtime" - the same one the report already reads from), as a login with
  sysadmin / setupadmin rights.

  Creates one linked server to the "center" (192.168.110.30), which hosts 3
